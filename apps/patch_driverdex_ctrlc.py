#!/usr/bin/env python3
"""
patch_driverdex_ctrlc.py  —  Fix all Ctrl+C / KeyboardInterrupt gaps in driverdex_builder.py
...
Usage:
    python patch_driverdex_ctrlc.py                      # patches driverdex_builder.py in CWD
    python patch_driverdex_ctrlc.py path/to/driverdex_builder.py
"""
